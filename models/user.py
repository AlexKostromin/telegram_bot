...
class UserModel(Base):
    ...
    classic_rating: Optional[int] = Column(Integer, nullable=True)
    quick_rating: Optional[int] = Column(Integer, nullable=True)
    team_rating: Optional[int] = Column(Integer, nullable=True)
